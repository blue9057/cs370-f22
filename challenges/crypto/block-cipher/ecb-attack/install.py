...
target_path = '/home/labs/crypto/ecb-attack'
target_level = 'week1-level4-solved'

files_to_copy = ['ecb-decryptor.py', 'ecb-encryptor.py',
        'flags', 'key', 'launcher', 'output.txt', 'encrypted.user', 'user.py', 'template.py']

protected = ['flags', 'key', 'launcher']
suid_target = 'launcher'
target_script = 'ecb-decryptor.py'
